public class QuantityMeasurementApp {
    ...
    public static void demonstrateFeetEquality() {
        Length obj1 = new Length(6.7, LengthUnit.FEET);
        Length obj2 = new Length(6.7, LengthUnit.FEET);
    ...
    public static void demonstrateInchesEquality() {
        Length obj1 = new Length(10.0, LengthUnit.INCHES);
        Length obj2 = new Length(10.0, "inch");
